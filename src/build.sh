...
# ==============================================================
# [UPDATED STEP 8]  Create dual-partition disk (boot + rootfs)
# ==============================================================

echo "[8/10] Packaging boot+rootfs into dual-partition disk image..."
IMG_MB=1024
BOOT_MB=64
ROOT_MB=$((IMG_MB-BOOT_MB))

dd if=/dev/zero of="$DISK_IMG" bs=1M count=$IMG_MB
