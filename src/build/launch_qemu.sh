-append "console=ttyS0 loglevel=7 root=/dev/dm-0 rootfstype=ext4 rootwait dm_verity_autoboot.autoboot_device=/dev/vda dm_verity_autoboot.mode=verify_and_map"
#!/bin/bash
set -euo pipefail
